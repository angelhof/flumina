...
public class PageViewProcessParallel extends CoProcessFunction<GetOrUpdateOrHeartbeat, PageViewOrHeartbeat, Update> {
    ...
    public PageViewProcessParallel(final int pageViewParallelism) {

...
*** TODO Synchronize producers when they start executing.

Make the producers wait for a message so that they all start together.

*** TODO Implement producers that can generate messages and timestamp them.
...
*** TODO Implement a checkpoint mechanism
...
*** TODO Implement a plot script that plots from latency logs

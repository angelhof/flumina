...
*** TODO Think of a proper Flumina interface

At the moment, writing a Flumina program is simple, but executing it requires a big mess, of
calling different producers, etc etc.
